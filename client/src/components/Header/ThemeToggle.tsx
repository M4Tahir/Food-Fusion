...
const Light = ({ height = 32, width = 32, fill = 'fill-accent2' }: ThemeToggleProps) => {
	return (
		<svg
...
const Dark = ({ height = 32, width = 32, fill = 'fill-accent2' }: ThemeToggleProps) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			height={`${height}px`}
	...
	return (
		<Modal lockScroll={false}>
			...
			<Modal.Open modalName="theme-win">
				<button
					className="duration-300 ease-out hover:scale-105 hover:cursor-pointer"
					ref={triggerRef}
				>
