...
const handleError = (err) => {
	...
	if (err instanceof jwt.TokenExpiredError) return new ExpressErrorHandler(`${err.message}, please login again`, 401);

	if (err instanceof jwt.JsonWebTokenError) return new ExpressErrorHandler(`invalid token or token missing, please login again`, 401);
