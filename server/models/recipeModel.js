...
const recipeSchema = new mongoose.Schema(
	{
		title: {
			...
			maxLength: [
				100,
				"Recipe name can't exceeds 100 character",
			] /*Indexes are used to improve query performance by allowing MongoDB to quickly locate documents without scanning the entire collection.
        What it does:
